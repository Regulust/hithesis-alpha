...
\documentclass[newtxmath=true,newgeometry=two,capcenterlast=true,subcapcenterlast=true,openright=false,absupper=true,stage=zhongqi,type=master]{hithesis}
...
\makecover	%若maketitle报错，可在上面两行切换论文封面文件
